...
class UserModelCase(unittest.TestCase):
    ...
    def test_add_data(self):
        ...
        shop2 = Shop(
            name="Rau cu xanh offical",
            address="1/2/3 Duong street",
            phone_no="1923456780",
            no_selling=105,
            no_sold=55,
            review_id=2,
        ...
        # Notifications table
        noti1 = Notifications(
            user_id=1, raucu_id=1, description="Sale off 20%", noti_type="sale_off"
        )
        noti2 = Notifications(
            user_id=1, raucu_id=2, description="Sale off 30%", noti_type="sale_off"
        )
        noti3 = Notifications(
            user_id=2, raucu_id=1, description="Sale off 25%", noti_type="sale_off"
        )
        noti4 = Notifications(
            user_id=2, raucu_id=2, description="Sale off 10%", noti_type="sale_off"
        )
